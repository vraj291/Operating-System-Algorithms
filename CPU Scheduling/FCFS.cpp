...
void FCFS(int _at[],int _bt[],int len){
    ...
    writeToFile("FCFS_output.txt",processes,len);
}

int main(){

    string filename = "FCFS_input.txt";
    ...
    FCFS(_at,_bt,sizeof(_at)/sizeof(_at[0]));

    cout << "\nOutput written to : FCFS_output.txt";
